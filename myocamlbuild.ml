...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("src/configurator", ["src"])];
     lib_c = [];
     flags =
       [
          (["oasis_library_configurator_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_library_configurator_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_library_configurator_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          ([
              "oasis_library_configurator_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_library_configurator_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])]);
          (["oasis_library_configurator_native"; "ocaml"; "compile"; "native"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "@a"])])
       ];
     }
